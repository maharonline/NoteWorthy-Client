  ...
  return (
    ...
    <div className="min-h-screen dashboard-bg">
      <div className="max-w-full mx-auto px-3 py-4">
        ...
        {/* Charts */}
        {users?.roles?.includes("Admin") && (
          <div className="card-bg p-4  mt-10">
    <h2 className="text-base font-semibold mb-2">User Statistics</h2>
    <div className="w-full h-[180px] sm:h-[220px] md:h-[280px] overflow-x-auto">
      {/* <div className="min-w-[300px] h-full"> */}
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={[
            { role: 'Students', count: Student },
            { role: 'Teachers', count: Teacher }
          ]}>
            <CartesianGrid strokeDasharray="3 3" strokeOpacity={0.2} />
            <XAxis dataKey="role" stroke="currentColor" />
            <YAxis stroke="currentColor" />
